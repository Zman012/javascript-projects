...
function mealAssembly(protein, grains, veggies, beverages, desserts, numMeals) {
  ...
  let meals = []; //holds the # of meals that user prompts - 
  
  /// Part A #2: Write a ``for`` loop inside this function
  /// Code your solution for part A #2 below this comment (and above the return statement) ... ///
//loop here - google a nested for loop (loop through a arrays with .length)
// we want to loop through the numMeals and loop through pantry
...
for (let i=0; i <numMeals; i++) {
  ...
  return meals;
  //nothing bast return on function will reun
}
/*
, 3- 5 
/ meals.push pantry - seperate 
*/
